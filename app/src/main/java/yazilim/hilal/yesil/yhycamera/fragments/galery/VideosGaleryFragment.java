...
import yazilim.hilal.yesil.yhycamera.databinding.FragmentGaleryVideoBinding;
...
public class VideosGaleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_galery_video, container, false);
    ...
    private void getVideoByOrderByDate(OnPhoneImagesObtained listener){
